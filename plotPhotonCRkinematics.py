...
outFile = TFile("photonCRkin.root","RECREATE")
...
for s in samples :
    ...
    for key in histoTemplate : 
        print key,histoMC[s][key].Integral()
...
for s in dataSamples :
    ...
    for key in histoTemplate :
        print key,histoData[s][key].Integral()
...
for key in histoTemplate : 
    ...
    can[key].SaveAs("photonCRkin_"+key+".eps")
    can[key].SaveAs("photonCRkin_"+key+".png")
    can[key].SaveAs("photonCRkin_"+key+".pdf")
